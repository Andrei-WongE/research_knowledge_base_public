---
name: agentMemory
description: A hybrid memory system that provides persistent, searchable knowledge management for AI agents. Use when the user requests searching or updating project memories, writing decisions to the memory bank, or checking memory status.
---
# agentMemory Skill

## Overview
A hybrid memory system that provides persistent, searchable knowledge management for AI agents. Use when the user requests searching or updating project memories, writing decisions to the memory bank, or checking memory status.

## Rules
- **Prerequisites**: Ensure Node.js is installed. Check if `agentMemory` is already installed in the project:
  ```bash
  ls -la .agentMemory
  ```
